...
- Platform: `claude`
- Runtime: `python`
- Entrypoint: `./bin/plugin-kit-ai-starter-claude-python`
...
```bash
printf '%s' '{"session_id":"starter-session","transcript_path":"/tmp/t.jsonl","cwd":".","permission_mode":"default","hook_event_name":"Stop","stop_hook_active":false,"last_assistant_message":"ok"}' | ./bin/plugin-kit-ai-starter-claude-python Stop
```
